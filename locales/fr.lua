Locales['fr'] = {
  ...
  ['deposit_object'] = 'Déposer un objet saisie',
  ['get_weapon'] = 'prendre Arme',
  ['put_weapon'] = 'Déposer une arme saisie',
  ['buy_weapons'] = 'acheter Armes',
  ['armory'] = 'Saisie définitive (irrécupérable)',
  ...
  ['license_gived'] = 'votre ~b~%s~s~ vous a été ~y~donner~s~!',
  ['licence_you_revoked'] = 'vous avez révoqué un ~b~%s~s~ qui appartenait à ~y~%s~s~',
  ['licence_you_ppa'] = 'vous avez donner le PPA',
